...
// set the inner HTML of the raisedCard using a template literal and toLocaleString for formatting
...
// set the inner HTML of the gamesCard using a template literal
